...
const slidingStack = () => {
  ...
  const slideData: slideType[] = [
    ...
    {title: "L Lawliet", image: '/imgs/slidingstack/l.jpg'},
    {title: "Aki Hayakawa", image: '/imgs/slidingstack/aki.jpg'},
    {title: "Saitama Sensei", image: '/imgs/slidingstack/saitama.jpg'},
    {title: "Mikasa Ackerman", image: '/imgs/slidingstack/mikasa.jpg'}
  ]
  useEffect(() => {
    ...
    const initializeSlider = () => {
      slideData.forEach((data, index) => {
        ...
        slide.innerHTML = `
                   <img class="slide-image" src="${data.image}" alt="${data.title}" />
